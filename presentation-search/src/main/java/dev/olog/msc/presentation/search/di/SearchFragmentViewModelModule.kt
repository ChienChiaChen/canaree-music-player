...
class SearchFragmentViewModelModule {
    ...
    internal fun provideSearchData(
        ...
        queryLiveData: MutableLiveData<String>
            ...
            : LiveData<Pair<MutableMap<SearchFragmentType, MutableList<DisplayableItem>>, String>> = runBlocking {
        ...
        Transformations.switchMap(queryLiveData) { input ->
            ...
            if (input.isBlank()) {
                ...
                runBlocking { getAllSongsUseCase.execute() }.asObservable()
                    .flatMap {
    ...
    private fun provideSearchBySong(
        ...
        getAllPodcastUseCase: GetAllPodcastUseCase,
        query: String
    ): Observable<MutableList<DisplayableItem>> = runBlocking {

        Observables.combineLatest(
            getAllSongsUseCase.execute().asObservable()
                .flatMapSingle { songs ->
                    songs.toFlowable()
                        .filter {
            ...
            getAllPodcastUseCase.execute().asObservable()
                .flatMapSingle { songs ->
                    songs.toFlowable()
                        .filter {
                            it.title.contains(query, true) ||
    ...
    private fun provideSearchByAlbum(
        ...
        Observables.combineLatest(
            getAllAlbumsUseCase.execute().asObservable()
            ...
            getAllPodcastAlbumsUseCase.execute().asObservable()
                .flatMapSingle { albums ->
                    albums.toFlowable()
                        .filter {
                            it.title.contains(query, true) ||
    ...
    private fun provideSearchByArtist(
        ...
        Observables.combineLatest(
            getAllArtistsUseCase.execute().asObservable()
                .flatMapSingle { artists ->
                    artists.toFlowable()
                        .filter { it.name.contains(query, true) }
                        .map { it.toSearchDisplayableItem() }
                        .toList()
                },
            getAllPodcastArtistUseCase.execute().asObservable()
                .flatMapSingle { artists ->
                    artists.toFlowable()
                        .filter { it.name.contains(query, true) }
                        .map { it.toSearchDisplayableItem() }
    ...
    private fun provideSearchByPlaylist(
        ...
        Observables.combineLatest(
            getAllPlaylistsUseCase.execute().asObservable()
                .flatMapSingle { artists ->
                    artists.toFlowable()
            ...
            getAllPodcastPlaylistUseCase.execute().asObservable()
                .flatMapSingle { artists ->
                    artists.toFlowable()
                        .filter { it.title.contains(query, true) }
                        .map { it.toSearchDisplayableItem() }
    ...
    private fun provideSearchByGenre(
        ...
        getAllGenresUseCase.execute().asObservable()
            .flatMapSingle { artists ->
                artists.toFlowable()
                    .filter { it.name.contains(query, true) }
                    .map { it.toSearchDisplayableItem() }
    ...
    private fun provideSearchByFolder(
        ...
        getAllFoldersUseCase.execute().asObservable()
            .flatMapSingle { artists ->
                artists.toFlowable()
                    .filter { it.title.contains(query, true) }
                    .map { it.toSearchDisplayableItem() }
    ...
    private fun provideRecents(
        ...
        getAllRecentSearchesUseCase: GetAllRecentSearchesUseCase,
        searchHeaders: SearchFragmentHeaders
    ): Observable<MutableList<DisplayableItem>> {
