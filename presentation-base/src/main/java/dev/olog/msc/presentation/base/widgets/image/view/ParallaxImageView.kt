...
class ParallaxImageView(
    ...
    init {
        ...
        parallax = a.getInt(R.styleable.ParallaxImageView_parallax, DEFAULT_PARALLAX)
        maxScrimAlpha = a.getInt(R.styleable.ParallaxImageView_max_scrim_alpha_255, MAX_ALPHA).toFloat()
        a.recycle()
