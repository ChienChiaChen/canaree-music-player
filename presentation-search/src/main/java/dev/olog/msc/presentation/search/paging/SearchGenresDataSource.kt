...
class SearchGenresDataSource @Inject constructor(
    ...
    init {
        launch {
            withContext(Dispatchers.Main) { lifecycle.addObserver(this@SearchGenresDataSource) }
...
internal class SearchGenresDataSourceFactory @Inject constructor(
    private val dataSourceProvider: Provider<SearchGenresDataSource>
) : DataSource.Factory<Int, DisplayableItem>() {

    private var filterBy: String = ""
    private var dataSource: SearchGenresDataSource? = null
