...
//    arguments state
    ...
    const val ARGUMENT_SHOW_NEXT = "$TAG.ARGUMENT_SHOW_NEXT"
    const val ARGUMENT_SHOW_PREVIOUS = "$TAG.ARGUMENT_SHOW_PREVIOUS"
    const val ARGUMENT_BOOKMARK = "$TAG.ARGUMENT_BOOKMARK"
