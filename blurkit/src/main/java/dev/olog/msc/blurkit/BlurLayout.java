...
public class BlurLayout extends FrameLayout {
    ...
    private Point getPositionInScreen() {
        ...
        return new Point(MathUtils.clamp(
                ints[0], 0, Integer.MAX_VALUE), // sometimes gives negative value
                ints[1] - this.statusBarHeight // offset the y value by status bar height
        );
    }
