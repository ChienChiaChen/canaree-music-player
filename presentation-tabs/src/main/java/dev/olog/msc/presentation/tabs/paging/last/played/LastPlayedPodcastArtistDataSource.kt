...
internal class LastPlayedPodcastArtistDataSourceFactory @Inject constructor(
    dataSourceprovider: Provider<LastPlayedPodcastArtistDataSource>
) : BaseDataSourceFactory<DisplayableItem, LastPlayedPodcastArtistDataSource>(dataSourceprovider)