...
internal class FolderRepository @Inject constructor(
    ...
    override fun getAll(): PageRequest<Folder> {
    ...
    override fun getSongListByParam(param: String): PageRequest<Song> {
        return PageRequestImpl(
    ...
    override fun getSiblings(mediaId: MediaId): PageRequest<Folder> {
        return PageRequestImpl(
