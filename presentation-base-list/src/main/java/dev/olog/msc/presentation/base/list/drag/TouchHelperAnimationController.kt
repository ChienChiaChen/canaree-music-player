...
class TouchHelperAnimationController {
    ...
    private val interpolator by lazy(LazyThreadSafetyMode.NONE) { DecelerateInterpolator() }
    private val bounce by lazy(LazyThreadSafetyMode.NONE) { BounceInterpolator() }
