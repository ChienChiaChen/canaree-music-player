...
internal class RecentlyAddedPodcastAlbumDataSourceFactory @Inject constructor(
    dataSourceProvider: Provider<RecentlyAddedPodcastAlbumDataSource>
) : BaseDataSourceFactory<DisplayableItem, RecentlyAddedPodcastAlbumDataSource>(dataSourceProvider)