...
import dev.olog.msc.shared.ui.extensions.colorAccentId
...
//    @ColorRes
//    var colorBackground: Int = if (context.isDark()) R.color.dark_dialog_background else android.R.color.white TODO color from res
    @ColorRes
